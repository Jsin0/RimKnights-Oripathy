...
namespace Originium
{
    ...
    public class WeatherEvent_OriginiumLightningStrike : WeatherEvent_LightningStrike
    {
        ...
        public static void DoStrike(IntVec3 strikeLoc, Map map, ref Mesh boltMesh)
        {
            ...
            {
                GenExplosion.DoExplosion(strikeLoc, map, 1.9f, RimWorld.DamageDefOf.Flame, null, -1, -1f, null, null, null, null, Originium.ThingDefOf.RM_OriginiumCluster, 0.15f, 1, null, false, null, 0f, 1, 0f, false, null, null, null, true, 1f, 0f, true, null, 1f, null, null);

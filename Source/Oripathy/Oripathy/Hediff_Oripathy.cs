        ...
        private void DoShatterCorpse()
        {
            ...
            if (base.pawn != null)
            {
                if (base.pawn.MapHeld != null)
                {
                    ...
                    GenExplosion.DoExplosion(center, map, radius, Originium.DamageDefOf.RK_ActiveOriginium, base.pawn, 1, -1f, null, null, null, null, ThingDefOf.RK_OriginiumCluster, 0.20f, 1, null, false, null, 0f, 1, 0f, false, null, null, null, true, 1f, 0f, true, null, 1f, null, null);
